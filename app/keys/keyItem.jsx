...
//           <Text style={styles.nyckelTitle}>{item.keyLabel.toUpperCase()}</Text>
//         </View>
...
function KeyItem({ item }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.topSection}>
        <View style={styles.info}>
          ...
          {normalizeStatus(item.status) === "checked-out" &&
            item.borrowedBy && (
              <Text style={styles.detail}>
                Lånetagare: {item.borrowedBy.name}
              </Text>
            )}
      ...
      {/* ---- Nedre rad (kameraikon till höger) ---- */}
      {showButton && (
